...
chimney_regions = {
    ...
    "smk2": [
        ...
        # Region(0, 0, 0, 0),
        Region(663 + 74  , 563 + 25 - 30 , 791 + 74 - 30  , 640 ),
        Region(718 + 109  , 591, 846 + 84 - 45  , 719 + 25 - 90),
        # Region(0, 0, 0, 0),
        Region(848 + 84  , 650 , 976 + 54  , 794 - 50 ),
    ...
    "tb4": [
        Region(61 - 8, 730, 189 - 8, 850),
        Region(418 - 20, 590, 546 - 20, 710),
        Region(786, 960, 914 - 20, 1055),
        Region(995 - 5, 950, 1123 - 5, 1055),
        # Region(0, 0, 0, 0),
        Region(1681 - 5, 630, 1809 - 5, 760)
    ]
}
