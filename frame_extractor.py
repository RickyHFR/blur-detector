...
chimney_regions = {
    "smk1": [
        Region(529, 621, 657, 749),
        Region(675, 578, 803, 706),
        Region(722, 752, 850, 880),
        Region(874, 730, 1002, 858),
        Region(896, 605, 1024, 733),
        Region(941, 634, 1069, 762),
        Region(1179, 597, 1307, 725)
    ],
    "smk2": [
        Region(392, 492, 520, 620),
        Region(439, 602, 567, 730),
        Region(451, 601, 579, 729),
        Region(663, 563, 791, 691),
        Region(718, 591, 846, 719),
        Region(742, 675, 870, 803),
        Region(848, 666, 976, 794),
        Region(979, 673, 1107, 801),
        Region(1105, 625, 1233, 753),
        Region(1127, 612, 1255, 740),
        Region(1198, 614, 1326, 742),
        Region(1283, 757, 1411, 885),
        Region(1396, 767, 1524, 895)
    ],
    "ad1": [
        Region(382, 632, 510, 760),
        Region(452, 635, 580, 763),
        Region(1096, 574, 1224, 702)
    ],
    "ad3": [
    ...
    "ad4": [
        Region(43, 536, 171, 664),
        Region(560, 615, 688, 743),
        Region(659, 607, 787, 735)
    ],
    "jtc1": [
        Region(174, 572, 302, 700),
        Region(553, 367, 681, 495),
        Region(1197, 571, 1325, 699),
        Region(1299, 402, 1427, 530),
        Region(1535, 438, 1663, 566),
        Region(1600, 529, 1728, 657),
        Region(1662, 534, 1790, 662),
        Region(1779, 531, 1907, 659)
    ],
    "jtc2": [
    ...
    "tb4": [
        Region(61, 774, 189, 902),
        Region(418, 638, 546, 766),
        Region(786, 980, 914, 1118),
